...
<div class="wrap">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="center-div">
            <div class="paper-name">ROZnama 92 news</div>
            <div class="station-name">
                <?php 

                    $user_id = yii::$app->user->id;
                    $user = \backend\modules\core\models\User::findOne($user_id);
                    echo $user->station['name'];

                ;?>
            </div>
        </div>
        <?php
        $logo = $assetBundle->baseUrl . '/images/logo.png';
        NavBar::begin([
        ...
        NavBar::end();
        ?>
         <div class="site-url"><a href="#">www.roznama92news.com</a></div>     
        <!-- SIDEBAR NAV -->
