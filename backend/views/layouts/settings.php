    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div class="navbar-default sidebar metismenu" role="navigation">
            ...
            <?= Nav::widget([
               ...
               'options' => ['class' =>'nav-pills'], // set this to nav-tab to get tab-styled navigati
...
<div id="page_loading">
  <img id="loading-image" src="<?php echo $assetBundle->baseUrl;?>/images/loading_page.gif" alt="Loading..." />
</div> 
<?php $this->endBody() ?>
</body>
</html>
