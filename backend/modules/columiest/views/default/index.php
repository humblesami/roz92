...
$this->title = Yii::t('yee/post', 'Column');
        ...
        <div class="panel-heading">
             ...
             <div class="row">
                <div class="col-sm-12 page-heading">
                    ...
                    <?= Html::a(Yii::t('yee', 'Add New'), ['/columiest/default/create'], ['class' => 'btn btn-sm btn-primary']) ?>
        ...
        <div class="panel-body">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'class' => 'yeesoft\grid\columns\TitleColumnActionColumn',
                        'controller' => '/columiest/default',
                        'title' => function (Post $model) {
                            return Html::a($model->title, ['columiest/default/view', 'id' => $model->id], ['data-pjax' => 0]);
                        },
                    ],
                    ...
                    [
                        ...
                        'value' => function (Post $model) {
                            return Html::a($model->profile['name'],
