...
namespace backend\modules\columiest;
...
class PostModule extends \yii\base\Module
{
    ...
    public $controllerNamespace = 'backend\modules\columiest\controllers';
    public $viewList;
    public $layoutList;
     ...
     * @var string
     */
    public $tagModelClass = 'backend\modules\columiest\models\Tag';
     ...
     * @var string
     */
    public $tagModelSearchClass = 'backend\modules\columiest\models\search\TagSearch';
