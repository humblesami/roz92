...
.map-left .btn{padding:7px; color:#008040; color:#fff;line-height:0.5;}
...
.custom_gp a{color:#000 !important; margin-top:5px;}
...
<div class="panel panel-default">
            ...
            <div class="row">
                ...
                <div style="height: 400px; position: fixed;width: 185px; z-index: 999"  >
...
<div class="btn-group pull-right custom_gp manage-emp-btn">
                <a href="#" data-toggle="dropdown" class="btn dropdown-toggle  over_dlt_btn">
                           ...
                ...
                <ul class="dropdown-menu pull-right new_link">
                    ...
                    <li>
                       <button class="btn-link theLink btn-sm" name="im[0][edit]" >Edit</button>
                    </li>

                    <li>
                         <button class="btn-link remove-row btn-sm" name="im[0][remove]">Delete
                            </button>
                    </li>
                ...
                <div class="col-sm-10 isscroll" style="margin-left:146px; width: 1000px">
...
<?php
                                ...
                                <?= $form->field($modelpost, 'post_type')->dropDownList($type_list,
                                    ['id' => 'post_type','class' => 'form-control search-select',
...
<?php
                                ...
                                ?>
                                <?= $form->field($modelpost, 'profile_id')->dropDownList($profile_list,
                                    ['prompt' => ' --- Select ---','id' => 'profile_id','class' => 'form-control search-select',
...
$sel_val = json_decode($modelpost->catValues,true);
 ...
 ['item' => function ($index, $label, $name, $checked, $value) {
        return '<div>'
                . '<label>'
                . '<input type="checkbox" {$checked} class="xcheck" id="c_' . $value . '"  name="' . $name . '" value="' . $value . '"> '
...
$(document).ready(function() {
   // $('.theLink').click(function(){
    $('#post_type').change(function(){
         $('#div-profile').hide();
         $('#c_22').prop('checked',false);
        if($(this).val() == 2){
             $('#div-profile').show();
             $('#c_22').prop('checked',true);
        }
    })
