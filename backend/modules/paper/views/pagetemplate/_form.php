...
<div class="tbl-pap-page-template-form xpage-template">
...
<input type="checkbox" <?php if($is_common == "Y"){ echo "checked";}?> name="common_check" id="common_check" class="common_check" value="Y" /> This is a common page
