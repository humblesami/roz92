var inrwrpH  = ($(window).outerHeight() - $('.toolbar').outerHeight() - $('.footer').outerHeight() - 90);(function($) {
	"use strict";
...
/*					 var inrwrpH  = ($(window).outerHeight() - $('.toolbar').outerHeight() - $('.footer').outerHeight() - 116);
					 $('.subviews-top').height(inrwrpH);*/
						$('.main-container').css({
							'max-height': inrwrpH - topBar.outerHeight(true),
							'min-height': inrwrpH - topBar.outerHeight(true),
							'overflow': 'hidden',
						});
					});
					switch (settings.startFrom) {
