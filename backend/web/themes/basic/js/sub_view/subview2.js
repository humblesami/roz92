(function($) {
	"use strict";
	var subViews = $(".subviews2"), show_functions = [], close_functions = [], hide_functions = [], subview_id = [], screenPosition, $this, subViewElement, subviewShowClass = ".show-sv", subviewHideClass = ".hide-sv", subviewBackClass = ".back-sv", subview_action = "", thisBody = document.body || document.documentElement, thisStyle = thisBody.style, supportTransition = thisStyle.transition !== undefined || thisStyle.WebkitTransition !== undefined || thisStyle.MozTransition !== undefined || thisStyle.MsTransition !== undefined || thisStyle.OTransition !== undefined;
	...
	$.extend({
		subview: function(options) {
			...
			if(subViews.is(":visible") == false) {
							...
							subViews.addClass("subviews-right").css({
								...
								$(this).css({
									...
									if($(subview_id[0]).length) {
										$(subview_id[0]).appendTo(".subviews-container2").show(0, function() {
											if(jQuery.isFunction(show_functions[show_functions.length - 1])) {
												show_functions[show_functions.length - 1].call($this);
											}
										});
									} else {
										$(".subviews-container2").html("<h3 class='center'>Sorry this page is not available</h3>");
									}
				...
				$(".subviews-container2").children().filter(':visible').fadeOut(function() {
					if(jQuery.isFunction(hide_functions[hide_functions.length - 2])) {
						hide_functions[hide_functions.length - 2].call($this);
					}
					$(this).appendTo("body");

					$(subview_id[subview_id.length - 1]).appendTo(".subviews-container2").show(0, function() {
		...
		hideSubview: function() {
			if(subview_id.length > 1 && subview_action !== "close") {
				...
				$(".subviews-container2").children().filter(':visible').fadeOut(function() {
					...
					subview_id.pop();
					$(this).appendTo("body");
					$(subview_id[subview_id.length - 1]).appendTo(".subviews-container2").fadeIn(function() {
						if(jQuery.isFunction(show_functions[show_functions.length - 1])) {
							show_functions[show_functions.length - 1].call($this);
						}
					});
				...
				subview_action = "";
				$(".subviews-container2").children().hide(0, function() {
					if(jQuery.isFunction(hide_functions[hide_functions.length - 1])) {
						hide_functions[hide_functions.length - 1].call($this);
					}
					$(this).appendTo("body");
