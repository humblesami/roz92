var UITreeview = function() {
	...
	var runTreeView = function(store_id) {
		//Default Tree
		$('#tree').jstree({
			"core" : {
				"themes" : {
		...
		$("#tree_3").jstree({
			...
			var l = "/estore/backend/web/index.php?r=build_content/category/update_parent&parent_id=" + parent_id + "&category_id=" + category_id + "&position=" + position;
			$.get(l,function(data){
				document.location.href = "/estore/backend/web/index.php?r=build_content/category/main&store_id=" + store_id + "&category_id=" + category_id + "&edit_mode=Y";
			});
		...
		$("#tree_3_master").jstree({
			...
			var parent_id = data.parent;
			var category_id = data.node.id;
			var l = "/estore/backend/web/index.php?r=taxonomy/category/update_parent&parent_id=" + parent_id + "&category_id=" + category_id;
			$.get(l,function(data){
				document.location.href = "/estore/backend/web/index.php?r=taxonomy/category/main&store_id=" + store_id + "&category_id=" + category_id + "&edit_mode=Y";
			});
