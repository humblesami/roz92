...
?>
<script src="/efrontend/web/js/jquery.rwdImageMaps.js?<?php echo time();?>"></script>
<div class="row rowrtl" style="padding:0px;margin:0px">                      
    <div class="col-md-12 col-lg-9 col-sm-12 col-xs-12 right-col" style="padding:0px;margin:0px">
         <img src="<?php echo  $image;?>" class="img-responsive"  usemap="#image-map" alt="">
        <?php echo $map_data;?>
...
<style type="text/css">
.adslot_1 { width: 175px; }

@media (min-width:500px) { .adslot_1 { width: 100px; height: 60px; } }
@media (min-width:800px) { .adslot_1 { width: 200px; height: 300px; } }
</style>
