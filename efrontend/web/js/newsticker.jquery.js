    ...
    $.fn.newsticker.methods = {
        ...
        startup: function() {
            var self = this,
                ...
                list = dom.list;
            list.wrap('<div class="newsticker_wrapper newsticker_style_' + settings.style + '" id="newsticker_' + this.api('getId') + '" style="position: relative; z-index: 0; overflow: hidden; "></div>');
